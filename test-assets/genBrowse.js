...
module.exports = (browser) => {
    ...
    .waitForElementVisible('//li[@class="product__container__details__color__items__item last"]', 10000)
    ...
    .waitForElementVisible('//div[@class="header section"]', 10000)
